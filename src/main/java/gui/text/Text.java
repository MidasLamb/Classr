...
public class Text implements Typable {
	 ...
	 * 
	 * @param as
	 *            The attributed string containing the text that need to be
	 *            displayed
	 * @param startState
	 *            The current state for this object
	 */
	...
	/**
	 * Sets the attributedstring text and synchronizes it with the text in the
	 * string
	 * 
	...
	/**
	 * Given an attributedstring this function returns the text value in a
	 * string
	 * 
	 * @param as
	 *            The attributed string
	 * @return the corresponding string containing the text of the attributed
	 *         string
	 */
