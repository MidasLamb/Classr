...
public class ChangeClassContentStaticCommand extends Command {
	 ...
	 * @param setStatic
	 * 			The value to which to set the being static of the ClassContent.
	 */
	...
	/**
	 * Returns the value of to which to set the being static of the ClassContent, given during construction.
	 * @return The value of to which to set the being static of the ClassContent, given during construction.
	 */
	...
	/**
	 * Returns the value of what whether or not the ClassContent was static before this command was executed.
	 * @return The value of what whether or not the ClassContent was static before this command was executed.
	 */
