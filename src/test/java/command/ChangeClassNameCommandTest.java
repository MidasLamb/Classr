...
public class ChangeClassNameCommandTest {

	@Test
	public void changeNameTest1() {
		Controller controller = new Controller();
		LogicalClass classe = new LogicalClass();
		Command c = new ChangeClassNameCommand(classe, "Nieuwe_naam");
	...
	public void changeNameTest5() {
		...
		Command c1 = new ChangeClassNameCommand(classe1, "Nieuwe_naam1");
		LogicalClass classe2 = new LogicalClass();
		Command c2 = new ChangeClassNameCommand(classe2, "Nieuwe_naam2");
